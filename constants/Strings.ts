export const Strings = {
  pt: {
    ...
    settings: {
      ...
      cookies: {
        description:
          'Este controlo aplica-se à versão web. Ao ativar publicidade, a app pode usar cookies de publicidade e mostrar anúncios. Ao desativar, os anúncios deixam de ser mostrados',
        currentStatus: 'Estado atual',
        toggleLabel: 'Ativar publicidade',
        toggleHelp:
          'Ligado: aceita cookies de publicidade e permite mostrar anúncios. Desligado: bloqueia cookies de publicidade e desativa anúncios',
        supportNote:
          'Ao permitir publicidade, ajuda a financiar a manutenção e o desenvolvimento contínuo da app',
        status: {
    ...
    cookies: {
      ...
      description:
        'Usamos cookies para mostrar anúncios relevantes na versão web. Pode aceitar ou rejeitar cookies não essenciais.',
      accept: 'Aceitar',
      reject: 'Rejeitar',
    },
    medication: {
