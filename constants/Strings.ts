export const Strings = {
  pt: {
    ...
    procedures: {
      ...
      emptyMessage: 'Toque em Novo procedimento para criar a sua lista de verificação',
      ...
      builtinBadge: 'Incluído',
      userBadge: 'Meu',
      readOnly: 'Procedimento incluído — duplicar para editar',
      disclaimer:
      ...
      deleteMessage:
        'Tem a certeza de que pretende eliminar "{{title}}"? Esta ação não pode ser anulada.',
